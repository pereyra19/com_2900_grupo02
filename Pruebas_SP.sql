...
EXECUTE AS USER = 'log_Admin_General';
...
EXECUTE AS USER = 'log_Admin_Bancario';
...
EXECUTE AS USER = 'log_Admin_Operativo';
    -- Importar TXT
    EXEC dbo.sp_Importar_UF_por_consorcio 
        @ruta = N'C:\Users\Spooky\Documents\consorciosUF por consorcio.txt';
 
    -- Importar archivo de Inquilino-propietarios-UF
    EXEC dbo.sp_ImportarInquilinoPropietariosUFCSV 
        @ruta = N'C:\Users\Spooky\Documents\consorciosInquilino-propietarios-UF.csv';
REVERT;
GO
 
-- Se ejecuta como Sistemas
EXECUTE AS USER = 'log_Sistemas';
    -- Reporte 1
    EXEC dbo.rpt_R1_FlujoCajaSemanal @FechaDesde  = '2025-01-01', @FechaHasta  = '2025-12-31', @IdConsorcio = NULL;

...
EXEC master.dbo.sp_MSset_oledb_prop N'Microsoft.ACE.OLEDB.16.0',N'AllowInProcess',1; -- si no funciona con 1 pone 0 
...
SELECT dbo.EsFeriado('2025-05-25');
SELECT dbo.EsFeriado('2025-05-26');
...
SELECT * FROM FacturaExpensa WHERE fechaEmision = '2025-04-25';
